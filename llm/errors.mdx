...
Failed jobs are billed **nothing**, regardless of the cause. Video and music job failures currently
carry only the human-readable `error` string; typed causes will arrive there in the same shape.
