...
| Nano Banana Pro | `nano-banana-pro` | $0.1072 | Higher quality, 1K–2K (set via `size`; >2048px auto-upgrades to Pro 4K) |
| Nano Banana Pro 4K | `nano-banana-pro-4k` | $0.192 | 4K resolution — also reached by `size` above 2048px |
