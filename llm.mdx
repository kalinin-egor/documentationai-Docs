...
|-------|------|---------------|-------|
| Nano Banana | `nano-banana` | $0.0312 | Fast text-to-image & image-to-image |
...
`nano-banana-pro`, `nano-banana-pro-4k`, or `grok-4-image`. Billing is
flat per returned image — no token accounting.
...
<ParamField body="model" type="string" required>
  Image model slug: `nano-banana`, `nano-banana-pro`, `nano-banana-pro-4k`, or `grok-4-image`.
</ParamField>
