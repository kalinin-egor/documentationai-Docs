...
without reference images. The same ceiling rule applies to
**Nano Banana Pro**: a `size` above 2048px auto-upgrades the request to
`nano-banana-pro-4k` ($0.192) so a 4K ask renders real 4K instead of
silently clamping to 2K.
